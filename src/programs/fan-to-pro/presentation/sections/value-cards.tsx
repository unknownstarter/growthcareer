...
const CARDS: Array<{
...
}> = [
  {
    ...
    en: "REAL STAGE",
    kr: "실제 공연 참여",
    body: "실제 K-pop 공연 한 시즌을 멘토와 함께 풀 사이클로 진행. 사진·영상·공연 데이터까지 결과물로 남는다.",
    accent: "indigo",
  },
  {
    number: "02",
    en: "PORTFOLIO",
    kr: "포트폴리오 + 면접",
    body: "이력서·포트폴리오·면접 코칭까지. 면접관이 신뢰하는 형식으로 결과물을 정리한다.",
    accent: "purple",
  },
  {
    number: "03",
    en: "NETWORK",
    kr: "업계 네트워킹",
    body: "현직 멘토 3인 + 동기 + 유니온 픽처스 수료증. 한 시즌 끝나도 카카오톡 오픈채팅으로 이어진다.",
    accent: "pink",
  },
];
