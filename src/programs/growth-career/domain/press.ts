...
export const PRESS_ARTICLES: PressArticle[] = [
  {
    ...
    titleKo: "외국인 유학생이 엔터테인먼트 산업으로. 드롭다운과 DEEPI, 엔터테인먼트 실무 교육 1기 수료생 배출",
    descKo: "1개월 교육을 마치고 첫 수료생을 배출. K-팝과 공연 등 엔터테인먼트 산업 실무 중심의 글로벌 인재 양성 프로그램.",
    titleEn: "International students into entertainment. Dropdown and DEEPI graduate their first entertainment training cohort",
    descEn: "The first graduates complete a one-month program. A global talent program centered on K-pop and live production.",
  },
  {
    ...
    titleKo: "드롭다운과 DEEPI, 엔터테인먼트 실무 교육 강사 공개 모집. K-팝과 공연 실무 전문가 찾는다",
    descKo: "커리어 플랫폼 드롭다운과 DEEPI가 K-팝과 공연 음향 등 엔터테인먼트 실무 전문가를 대상으로 강사를 공개 모집.",
    titleEn: "Dropdown and DEEPI open a public call for entertainment training instructors, seeking K-pop and live production experts",
    descEn: "Career platform Dropdown and DEEPI open a public call for working experts across K-pop and live production.",
  },
  {
