...
| **Cowork 마케팅 수수료** | **1,161,600** | **결제 인원 × 수강료 12% = 11 × 880,000 × 0.12** |
| 소계 | **7,261,600** | |
...
- 비용 1인 = 약 660,000원 (7,261,600 / 11)
- 마진 1인 = 약 140,000원

### 마진율 영향 분석

Cowork 수수료 도입 → 마진율 30% → 17.5%로 약 12.5%p 하락 (수수료율과 일치).

다음 기수 시 재검토 사항:
- 정원 30명 가정 시: 매출 26.4M / Cowork 수수료 3.17M → 마진 약 5M (마진율 18% 유지 — 변화 X)
