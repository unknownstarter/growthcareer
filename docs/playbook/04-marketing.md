...
- **마케팅 수수료 12%** — Cowork 에 결제 인원당 수강료 12% 정산. 1기 = 10명 × 880,000 × 12% = 1,056,000원 (6/22 11명 → 6/23 환불 1명 기준). 자세한 산정 기준 (VAT 포함/제외, 환불 시 차감, 정산 시점) 은 약정 따라 — `06-finance-tax.md` 참조.
...
- 마감 후 paid 10명에게 cohortKickoff 메시지에 PDF 링크 첨부 (구글 드라이브)
...
- **반자동 결제 흐름** — 운영자 1명이 10명 처리 가능 (피로 수용 가능 수준)
