...
| Low | F13. 대량 invite onboarding 자동화 (CSV upload) | 운영자 | 1기 10명 = 수동 | 3일 | Wave 5 (100명+) |
...
수료증 PDF 수동 생성 (Dropdown 명의). 1기는 10명 = 수동 가능. 다음 기수 30명+ = 자동화 필요.
...
- 8원/건 → 10명 × 5종 메시지 × 2 cohort = 약 100~200원 / cohort (저렴)
...
- 표본 작음 (10명 × 3 강사 = 30 평가) — 통계적 신뢰도 제한
