  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className={`${WRAP} pt-16 sm:pt-20`}>
        <div className="h-5 w-28 animate-pulse rounded bg-fill" />
      ...
      <section className={`${WRAP} pt-10 pb-24`}>
        <div className="flex flex-col gap-4">
          {Array.from({ length: 3 }).map((_, i) => (
            ...
            >
              <div className="aspect-[16/9] w-full shrink-0 animate-pulse bg-fill sm:aspect-auto sm:w-64 md:w-80" />
              <div className="flex flex-1 flex-col p-6 sm:p-7">
                <div className="h-4 w-32 animate-pulse rounded bg-fill" />
                <div className="mt-3 h-6 w-4/5 animate-pulse rounded bg-fill" />
