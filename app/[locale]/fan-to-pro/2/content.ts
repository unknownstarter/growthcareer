...
const CONTENT = {
  ko: {
    ...
    press: {
      ...
      items: [
        { title: "외국인 유학생이 K-컬처 산업으로. 드롭다운과 DEEPI, 'K컬처 아카데미' 1기 수료생 배출", desc: "1개월 교육을 마치고 첫 수료생을 배출. K-팝, 공연, 패션, 뷰티 등 산업 실무 중심의 글로벌 인재 양성 프로그램." },
        { title: "드롭다운과 DEEPI, 'K컬처 아카데미' 강사 공개 모집. K-팝, 뷰티, 패션 실무 전문가 찾는다", desc: "K-컬처 커리어 플랫폼 드롭다운과 DEEPI가 K-팝, K-뷰티, 패션 등 다양한 분야의 실무 전문가를 대상으로 강사를 공개 모집." },
    ...
    apply: {
      ...
      submit: "신청하기 →",
      guide: "무엇을 고르든 결제는 계좌이체로 안내됩니다. 신청서를 제출하면 운영자가 선택하신 과정과 금액을 확인해 입금 안내를 보내드립니다.",
      courses: [
    ...
    applyForm: {
      ...
      nationality: "국적", nationalityPh: "예: 베트남",
      birthdate: "생년월일",
      visa: "비자", visaPh: "선택",
      address: "주소", addressPh: "한국 내 거주지",
      ...
      successTitle: "신청 완료",
      success: "신청서가 접수됐습니다. 선택하신 과정과 금액을 확인해 입금 안내를 이메일로 보내드립니다.",
      errorTitle: "제출 실패",
  ...
  en: {
    ...
    press: {
      ...
      items: [
        { title: "International students into K-culture. Dropdown and DEEPI graduate the first 'K-Culture Academy' cohort", desc: "The first graduates complete a one-month program. A global talent program centered on K-pop, live production, fashion, and beauty." },
        { title: "Dropdown and DEEPI open a public call for 'K-Culture Academy' instructors, seeking K-pop, beauty, and fashion experts", desc: "K-culture career platform Dropdown and DEEPI open a public call for working experts across K-pop, K-beauty, fashion, and more." },
    ...
    apply: {
      ...
      submit: "Apply →",
      guide: "Whatever you choose, payment is guided by bank transfer. Once you submit, our team reviews your selected courses and amount and sends payment instructions.",
      courses: [
    ...
    applyForm: {
      ...
      nationality: "Nationality", nationalityPh: "e.g. Vietnam",
      birthdate: "Date of birth",
      visa: "Visa", visaPh: "Select",
      address: "Address", addressPh: "Your address in Korea",
      ...
      success: "Your application is in. We'll review your selected courses and amount and email you payment instructions.",
