...
const CONTENT = {
  ko: {
    ...
    applyForm: {
      ...
      residesInKorea: "저는 현재 한국에 거주하고 있습니다 (필수)",
      residesInKoreaNote: "서울에서 진행하는 주말 오프라인 강의라 한국 거주자만 신청할 수 있어요",
      submit: "신청서 제출",
      submitting: "제출 중...",
  ...
  en: {
    ...
    applyForm: {
      ...
      residesInKorea: "I currently live in Korea (required)",
      residesInKoreaNote: "Classes are in-person on weekends in Seoul, so only residents of Korea can apply",
