...
/* =============================================================================
   TEMP 프리뷰 — Growth Career 플랫폼 메인 (우산 브랜드) · 라이트, 원티드/잡플래닛 결
   ...
   전역 globals.css 안 건드림 (1기 동결). noindex. 실 라우트(/)는 승인 후.
   이중언어: locale 로 COPY 분기 (ko = /ko/gc-preview, en = /gc-preview).
   ============================================================================= */

export const metadata: Metadata = {
  title: "Growth Career (프리뷰)",
...
export default async function GcPreviewPage({
  params,
}: {
